...
// Manage projects: the full list with create/edit/delete. Reachable from the header
// "Proiecte" link. The home page ("/") is the dashboard of the selected project; this
// is where projects themselves are administered.
